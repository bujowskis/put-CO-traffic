...
def main():
    ...
    for file in files:
        ...
        # schedules_greedy.export(f'{file[0]}-greedy.txt')  # todo - export to schedules folder
    ...
    for file in files:
        ...
        # schedules_intelligent.export(f'{file[0]}-intelligent.txt')  # todo - export to schedules folder
        start_time = time.time()
